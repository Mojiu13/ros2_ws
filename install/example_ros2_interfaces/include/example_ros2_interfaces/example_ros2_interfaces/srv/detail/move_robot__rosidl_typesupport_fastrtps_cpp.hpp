...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_example_ros2_interfaces
cdr_serialize(
  const example_ros2_interfaces::srv::MoveRobot_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_ros2_interfaces::srv::MoveRobot_Event & ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_example_ros2_interfaces
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_ros2_interfaces, srv, MoveRobot_Event)();
